...
return [
	...
	__( 'Use the External Payment Device to take online card payments', 'wepos' ),
	__( 'Enable/Disable', 'wepos' ),
	__( 'Enable EPD Card gateway', 'wepos' ),
	__( 'EPD Card', 'wepos' ),
	__( 'Pay with EPD', 'wepos' ),
	__( 'Payment made using EPD Card', 'wepos' ),
	__( 'Card tendered amount: %1$s', 'wepos' ),
];
